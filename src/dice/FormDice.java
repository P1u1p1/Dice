...
public class FormDice extends javax.swing.JFrame {
    ...
    private void RollButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RollButtonActionPerformed
        int dieValue1, dieValue2;
        dieValue1 = (int)Math.ceil(Math.random()*6);
        dieValue2 = (int)Math.ceil(Math.random()*6);
       die1.setText(Integer.toString(dieValue1));
       die2.setText(Integer.toString(dieValue2));
